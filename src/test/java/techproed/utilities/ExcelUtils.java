...
public class ExcelUtils {
    ...
    private String path;
    //Constructor: Excell path ve sayfaya ulaşmak için kullanacagız
    ...
    //Excel deki verileri almamızı saglar list olarak return eder
    //Exceldeki verileri Test sınıfında kullanmak için bu methodu kullanacagzı
    ...
    //Exceldeki sutun sayısını return eder
    ...
    //Sair ve Sutun indexleri girildiginde  o cell deki dataları verir
    ...
    //Excell deki datalari iki boyutlu array şeklinde almamızı saglar
    ...
    //Deger ,satir ,sutun girildiğinde o satır ve sutuna girilen degeri yazdırır
    ...
    //Bu method ustteki metotla birlikde calısır.Overload eder.Para metreleri farklidir.
    ...
    //Exceldeki datalri baslıksız olarak 2 boyutlu return eder
