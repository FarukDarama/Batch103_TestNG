...
public class Day19_TestNGAnotations {
    ...
    /*
     ...
     -------------------------------------------------------------------------------------------
     @Ignore : @Test caseleri atlamak(skip,ignore) icin kullanılır
     @Test (enabled = false) :@Test caseleri kullanım dısı bırakmak icin kullanılabilir
     -------------------------------------------------------------------------------------------
     TestNG de test case ler isim sırasına gore calısır
    @Test( Priority = 1)  : Test caseleri oncelemek icin kullanılır
    Not: Default priority nin degeri 0 dır
